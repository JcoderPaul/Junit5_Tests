    ...
    */
    ...
    public Object resolveParameter(ParameterContext parameterContext,
        ...
        */
        ...
        Правда теперь нам придется в UserService передать UserDao,
        поскольку структура и взаимосвязь классов изменилась.
        */
        return myStore.getOrComputeIfAbsent(UserService.class, it -> new UserService(new UserDao()));
    }
}
